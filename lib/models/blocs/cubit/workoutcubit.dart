  ...
  void categoriesFilter() async {
    ...
    switch (_selected_index) {
      ...
      case 3:
        emit(ExerciseState.loaded(exercises
            .where(
              (e) => e.muscles.contains('Shoulders'),
            )
            .toList()));
        break;
      case 4:
      ...
      case 5:
        emit(ExerciseState.loaded(exercises
            .where(
              (e) => e.muscles.contains('Upper Chest'),
            )
            .toList()));
        break;
      case 6:
      ...
      case 11:
        emit(ExerciseState.loaded(exercises
            .where(
              (e) => e.muscles.contains('Lower Back'),
            )
            .toList()));
        break;
      case 12:
      ...
      case 13:
        emit(ExerciseState.loaded(exercises
            .where(
              (e) => e.muscles.contains('Full Body'),
            )
            .toList()));
        break;
      case 14:
